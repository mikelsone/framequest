...
<body>
    ...
    <div class="upload-section">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <label for="file" class="upload-trigger">Upload</label>
            <input type="file" name="file" id="file" onchange="previewImage()" />
            <div class="preview-container">
                <img id="previewImg" class="preview-img" src="https://cdn-icons-png.flaticon.com/512/1946/1946429.png" alt="Profile Preview">
            </div>
